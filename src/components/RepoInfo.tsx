...
export default function RepoInfo({
  ...
  return (
    <>
      <article className='w-full bg-slate-200  min-h-[350px] justify-between dark:bg-slate-800 rounded-xl  text-slate-800 dark:text-slate-200 p-8 flex flex-col gap-8 text-left text-lg'>
      ...
      <button
        onClick={refreshRepo}
        className='w-full dark:bg-slate-800 px-2 py-4 border-2 border-transparent hover:border-violet-500 rounded-xl text-xl drop-shadow-xl hover:drop-shadow-none transition ease-in duration-250 dark:text-slate-200 text-slate-800'
      >
        Refresh
      </button>
    </>

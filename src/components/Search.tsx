...
export default function Search({
  ...
  return (
    <form className='p-1 w-full mx-center border border-slate-800 rounded-xl dark:bg-slate-800 dark:text-slate-200 '>
      <Select
        unstyled={true}
        classNames={{
          container: () => 'text-left border-none rounded-xl w-full ',
          control: () =>
            `flex justify-between items-center p-3 rounded-lg cursor-pointer transition-all duration-150 dark:bg-slate-800 bg-slate-200 hover:cursor-pointer`,
          ...
          menuList: () => 'bg-slate-200 dark:bg-slate-800  p-4 rounded-lg shadow-lg ',
          option: (state) =>
          ...
          indicatorsContainer: () => 'flex bg-slate-200 dark:bg-slate-800',
